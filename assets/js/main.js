...
var _user$project$Page_LoginMsgs$SubmitCredentials = {ctor: 'SubmitCredentials'};
...
var _user$project$Msgs$Login = function (a) {
...
var _user$project$Commands$playerDecoder = A3(
	...
	A3(
		...
		A3(
			...
			'id',
			_elm_lang$core$Json_Decode$string,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Players_Model$Player))));
...
var _user$project$Page_LoginForm$view = function (state) {
	return A2(
								...
								{ctor: '[]'},
								{
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$value(state.username),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$for('username'),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onInput(_user$project$Page_LoginMsgs$SetUsername),
														_1: {ctor: '[]'}
													}
												}
											},
											...
											_1: {
												...
												_1: {
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$value(state.password),
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$for('password'),
																_1: {
...
var _user$project$Page_LoginForm$update = F2(
	function (msg, form_) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'SetUsername':
			...
			default:
				return {
					ctor: '_Tuple2',
					_0: form_,
					_1: A2(_user$project$Page_LoginForm$submitCredentials, form_.username, form_.password)
				};
		}
	});
...
var _user$project$Models$initialModel = function (route) {
	return {mdl: _debois$elm_mdl$Material$model, players: _krisajenkins$remotedata$RemoteData$Loading, user: _krisajenkins$remotedata$RemoteData$NotAsked, route: route, loginForm: _user$project$Page_LoginForm$initialLoginForm};
};
var _user$project$Models$Model = F5(
	function (a, b, c, d, e) {
		return {mdl: a, players: b, user: c, route: d, loginForm: e};
	});
									...
									{ctor: '[]'},
									{
										...
										_0: _elm_lang$html$Html$text(
											A2(
												...
												_user$project$Users_User$fullName(_p0._0))),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}),
						...
						_0: A2(
							...
							},
							{
								...
								_1: {
									...
									_0: A2(
										_elm_lang$html$Html$map,
										_user$project$Msgs$Login,
										_user$project$Page_LoginForm$view(form_)),
									_1: {ctor: '[]'}
								}
							}),
						_1: {ctor: '[]'}
...
var _user$project$Page_Body$page = function (model) {
	...
	switch (_p0.ctor) {
		case 'HomeRoute':
			return A2(_user$project$Page_Home$view, model.user, model.loginForm);
		case 'PlayersRoute':
...
var _user$project$Update$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			...
			default:
				var _p2 = A2(_user$project$Page_LoginForm$update, _p0._0, model.loginForm);
				var form = _p2._0;
				var cmd = _p2._1;
				return {
					ctor: '_Tuple2',
